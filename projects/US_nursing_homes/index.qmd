...
```{r}
#Found this mode function (did not write)
Mode <- function(x) {
  ux <- unique(x)
...
#checking for possible outliers/incorrect values in the data
#I decided to remove two points:	
#TWIN FOUNTAINS HOME of GA had a gross revenue of 1,300,406,865
#SANILAC COUNTY MEDICAL CARE FACILITY of MI had 22,287 beds
#This is important to note because after I removed them, Michigan changed to a slightly darker color on the first plot.
...
ggplot(nursing_data, aes(gross_revenue, snf_average_length_of_stay_total)) +
geom_point()
